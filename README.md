...
~~Survival Cup~~: Every team has one Pioneer. The way to win is by defeating the Pioneer. There is no team preview and you can't know who the pioneer is. (randomized for both NPC & player teams respectively)
~~Split Swap~~: Physical (Atk & Def) and Special (SpA & Sp.Def) respectively swap with each other
