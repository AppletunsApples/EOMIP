...
1. **Shared Levels**: All Pokemon's stats are calced to the same level.
2. **Benjamin Butterfree**: Pokemon devolve upon fainting. Once it has fainted in its initial form, it will be fainted until the next battle (unless revived).
3. **Split Stat Swap**: Physical (Atk & Def) and Special (SpA & Sp.Def) respectively swap with each other.
